-- 002_seed.sql — Expanded demo seed data for Indexly
-- Applied after 001_initial.sql.
-- Idempotent: uses ON CONFLICT DO NOTHING / DO UPDATE where possible.
-- This mirrors db/seeds/001_seed.sql so the standard migration path
-- (lexical order of db/migrations/*.sql) yields a fully populated demo DB.
...
-- =====================================================================
-- SITES (6 Acme, 6 NorthStar, 3 Brightline)
-- =====================================================================
...
-- =====================================================================
-- INDEX URLS (sample per a few jobs so dashboard "indexed" count > 0)
-- =====================================================================
INSERT INTO index_urls (id, job_id, url, status, submitted_at) VALUES
  (gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000001', 'https://acmecorp.com/',         'indexed', NOW() - INTERVAL '28 days'),
  (gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000001', 'https://acmecorp.com/pricing',  'indexed', NOW() - INTERVAL '28 days'),
  (gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000001', 'https://acmecorp.com/features', 'indexed', NOW() - INTERVAL '28 days'),
  (gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000001', 'https://acmecorp.com/contact',  'failed',  NOW() - INTERVAL '28 days'),
  (gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000003', 'https://blog.acmecorp.com/forecasting', 'indexed', NOW() - INTERVAL '22 days'),
  (gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000003', 'https://blog.acmecorp.com/cold-email',  'indexed', NOW() - INTERVAL '22 days'),
  (gen_random_uuid(), 'bbbb0002-0000-0000-0000-000000000001', 'https://northstarmedia.io/',         'indexed', NOW() - INTERVAL '27 days'),
  (gen_random_uuid(), 'bbbb0002-0000-0000-0000-000000000001', 'https://northstarmedia.io/agencies', 'indexed', NOW() - INTERVAL '27 days'),
  (gen_random_uuid(), 'bbbb0002-0000-0000-0000-000000000002', 'https://news.northstarmedia.io/ai',  'indexed', NOW() - INTERVAL '24 days'),
  (gen_random_uuid(), 'bbbb0002-0000-0000-0000-000000000008', 'https://northstarmedia.io/news',     'queued',  NULL),
  (gen_random_uuid(), 'cccc0003-0000-0000-0000-000000000001', 'https://brightlineseo.com/',         'indexed', NOW() - INTERVAL '21 days'),
  (gen_random_uuid(), 'cccc0003-0000-0000-0000-000000000001', 'https://brightlineseo.com/tools',    'indexed', NOW() - INTERVAL '21 days'),
  (gen_random_uuid(), 'cccc0003-0000-0000-0000-000000000004', 'https://tools.brightlineseo.com/serp', 'failed', NOW() - INTERVAL '7 days')
...
ON CONFLICT (site_id, term, country) DO NOTHING;
...
-- =====================================================================
-- WORDPRESS CONNECTIONS (encrypted password placeholder)
-- =====================================================================
